...
LearningTimeSteps = 35 * (10**5) ## Time step size for policy evaluation and deployment is 0.1 s

LearningRate_ini = 0.7e-4 # LR initial value for linear interpolation
...
if __name__ == '__main__':
    ...
    for i in range(1, 100): ## policies name format "PPO_Quad_<numberOfAttempt>.zip"
        ...
        filename_check = "/home/ghost/giorgio_diliberi/ReinforcementLearning/Stable_Baselines2_Frame/QuadEnvTest_6DOF_Att/Policies/PPO_Quad_" + str(i) + ".zip"
