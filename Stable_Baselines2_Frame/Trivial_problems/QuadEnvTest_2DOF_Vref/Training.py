...
if __name__ == '__main__':
    ...
    eval_env = DummyVecEnv([lambda : QuadcoptEnv_2DOF(Random_reset=False, Process_perturbations=True)]) # Definition of one evaluation environment
    ...
    for i in range(1, 100): ## policies name format "PPO_Quad_<numberOfAttempt>.zip"
        ...
        filename_check = "/home/ghost/giorgio_diliberi/ReinforcementLearning/Stable_Baselines2_Frame/Trivial_problems/QuadEnvTest_2DOF_Vref/Policies/PPO_Quad_" + str(i) + ".zip"
