...
LearningTimeSteps = 60 * (10**5) ## Time step size for policy evaluation and deployment is 0.1 s

LearningRate_ini = 0.6e-4 # LR initial value for linear interpolation
