...
LearningRate_ini = 5e-5 # LR initial value for linear interpolation
#LearningRate_fin = 1.0e-8 # LR final value for linear interpolation
LearningRate = linear_schedule(LearningRate_ini)

cliprange_ini = 0.25 # Clip initial value for linear interpolation
...
if __name__ == '__main__':
    ...
    eval_env = DummyVecEnv([lambda : QuadcoptEnv_2DOF(Random_reset=True, Process_perturbations=True)]) # Definition of one evaluation environment
