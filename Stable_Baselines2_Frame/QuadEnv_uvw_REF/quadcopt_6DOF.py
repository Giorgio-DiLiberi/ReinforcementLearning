...
# this model include a mathematical rapresentation of the quadcopter in which the goal is to define
# a vectorial reference and reach this as velocity module and direction
import numpy as np
...
class QuadcoptEnv_6DOF(gym.Env):
  ...
  def __init__(self, Random_reset = False, Process_perturbations = False):
    ...
    # previous comment
    self.Obs_normalization_vector = np.array([30., 30., 30., 50., 50., 50., 1., 1., 1., 1.]) # normalization constants
    # Random funcs
    ...
    # Now the reference are about velocity module and direction, for this first attempt errors are given on 
    # u, v, w components basing on the trim values to be achieved 
