...
class QuadcoptEnvV3(gym.Env):
  ...
  def __init__(self):
    ...
    ## Motor model is assumed simply as a maximum thrust multiplied by the throttle value
    # F = Max_thrust * dT
    ...
    self.dTt = self.mass * self.g0 / (4 * self.Max_motor_Thrust) # trim throttle to hover
